#ifndef __SMART_TRANSVERSAL_H
#define __SMART_TRANSVERSAL_H
...
void create_list_zigzag(Graph g, vector<tuple3> &EDGES, 
    vector<vector<pair<int,int>>> &CYCLE, int change, const int times){
